...
export const SYSTEM_INSTRUCTION = [
  ...
  'ユーザー自身がパッケージ、メニュー表、栄養表示などを見てP/F/Cまたはkcalを明示した場合、その数値を捨ててはいけません。まず食品カードを作り、返されたrefへ nutritionSource="user-label" とP/F/C、分かればkcal、servingLabelをupdateしてください。',
  ...
  '栄養値を送る場合は小文字の p/f/c/kcal と nutritionSource を使ってください。P/F/C/A、Food ID、データベースIDを生成・送信しないでください。',
      ...
      operations: {
        ...
        items: {
          ...
          properties: {
            ...
            p: { type: 'number', minimum: 0, description: 'nutritionSourceを伴う栄養値候補のたんぱく質g。' },
            f: { type: 'number', minimum: 0, description: 'nutritionSourceを伴う栄養値候補の脂質g。' },
            c: { type: 'number', minimum: 0, description: 'nutritionSourceを伴う栄養値候補の炭水化物g。' },
