export const LIVE_VERSION = 'v1.7.20';
...
export const SYSTEM_INSTRUCTION = [
  ...
  'アプリから __PFC_OFFICIAL_LOOKUP_NOT_FOUND__ または __PFC_INTERNAL_RECOVERY__ が来た場合だけ、candidateNamesに明確な同一食品があれば候補名へ同じrefをupdateしてFood Master再解決してください。',
  '公式検索で見つからず候補でも解決できず、ユーザー明示P/F/Cも無い食品に限り、最後の手段として内部知識または合理的な料理構成からp/f/cを作り、nutritionSource="ai-estimate" とservingLabelを同じrefへupdateしてください。',
...
export const UPDATE_MEAL_DRAFT_DECLARATION = {
  ...
  description: '現在の食事Draftを追加・訂正・削除する。食品名を理解した時点でPartial Draftを作る。ユーザー明示栄養値と、公式検索失敗後の最終手段AI推定を出典付きで同じrefへ追加できる。',
